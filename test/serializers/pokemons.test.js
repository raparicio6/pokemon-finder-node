const { serializePokemons, getHashedPokemonsNames } = require('../../app/serializers/pokemons');
const {
...
describe('serializePokemons', () => {
  let formattedPokemons = null;
  beforeAll(done => {
    formattedPokemons = serializePokemons([properGetPokemonRespButterfree]);
    return done();
  });
